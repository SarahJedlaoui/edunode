  ...
  render() {
    return (
      <>
        ...
        <h5>
        How can Soroban improve efficiency in businesses?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="Automating processes involved in creating and executing smart contracts"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="Providing enhanced transparency and accountability "
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="Reducing transaction costs "
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label=" Improving overall trust in the system"
              name="checkfour"
              id="form4"
