 ...
 React.useEffect(() => {
  ...
  const handleNext = () => {
    ...
    setTimeout(function () {
     ...
     window.location.href = '/courses/101/iiiii';
   }, 1000);
...
class Introiii extends Component {
  constructor(props) {
    super(props);
    this.state = {
      progress: 0,
...
Introiii = connect(mapStateToProps, { clearErrors })(Introiii);

export default Introiii = reduxForm({
  form: '',
  fields: [''],
  clearErrors,
