...
function getStepContent(step) {
  switch (step) {
    ...
    case 1:
      return 'Stellar allows anyone to create a redeemable, tradable representation of any asset. Such representations are called tokens. Tokens are most useful when tied to currencies (representing dollars or yuan or euros digitally makes payments borderless and instant) but in theory, on Stellar, you could issue a token for corn bushels or gold or shares of a REIT or an hour of your time as a consultant. In a sense, Stellar offers a generalized toolkit for anyone to do what Tether did for the Dollar with their USDT, or what Coinbase is doing with their USDC. Stellar lets you digitize value and then issue and redeem claims on it; the platform was designed for stablecoins before stablecoin was even a word. ';
    case 2:
 ...
 React.useEffect(() => {
  ...
  const handleNext = () => {
      //  const step = activeStep
       ...
       setTimeout(function () {
         window.location.href = '/courses/101/ii';
       }, 500);
...
Introi = connect(mapStateToProps, { clearErrors })(Introi);

export default Introi = reduxForm({
  form: '',
  fields: [''],
  clearErrors,
