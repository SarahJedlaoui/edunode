...
class Game extends Component {
  ...
  async handleSubmit(e) {
    ...
    if (this.state.grade === 0) {
      errors.grade = "Duration is required.";
    }
    ...
    const data = {
      ...
      duration: this.state.grade
    };
    try {
      const response = await fetch("https://edunode.herokuapp.com/api/game/", {
        method: "POST",
        headers: {
            ...
            <Grid item xs={12} sm={8} md={20}>
              ...
              <div style={{ padding: '10px' }}>
                <Form onSubmit={this.handleSubmit}>
                  <h4 style={{ fontSize: "2em", textAlign: "center" }}>Add Game Challenge:</h4>
                  ...
                  <FormGroup>
                    <Label htmlFor="description">Challenge Content:</Label>
                  ...
                  <FormGroup>
                    <Label htmlFor="title">Duration(minutes):</Label>
                    <TextField
                      name="grade"
                      id="grade"
                      placeholder="grade"
