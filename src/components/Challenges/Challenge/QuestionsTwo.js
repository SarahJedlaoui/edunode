      ...
      <>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label=" To secure Stellar accounts"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="To enable users to hold and transact with issued assets"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="To set up multi-signature accounts"
              name="checkfour"
              id="form4"
