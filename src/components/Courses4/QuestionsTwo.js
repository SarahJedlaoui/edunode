      ...
      <>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label=" To create a cryptocurrency"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="To support enterprise blockchain applications "
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label=" To create a decentralized social network"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="To provide a platform for online gaming"
              name="checkfour"
              id="form4"
