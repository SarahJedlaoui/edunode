  ...
  render() {
    return (
      <>
        ...
        <h5>
        What is a smart contract in Hyperledger?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="A legal agreement between two parties"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="A self-executing contract that automates agreement negotiation and execution "
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="A contract that can only be executed by a central authority"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="A contract that is stored off-chain"
              name="checkfour"
              id="form4"
