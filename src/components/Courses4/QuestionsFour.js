  ...
  render() {
    return (
      <>
        ...
        <h5>
        How does Hyperledger ensure privacy for transactions?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="By using a public blockchain"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="By encrypting all data on the blockchain"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="By providing different levels of privacy for transactions"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="By requiring participants to use their real names"
              name="checkfour"
              id="form4"
