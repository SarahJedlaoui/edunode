  ...
  render() {
    ...
    return (
      <>
        ...
        <h5>
        What is one of the main benefits of adopting SEPs for the Stellar ecosystem?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="Increased issuance of Stellar Lumens (XLM)"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="Improved interoperability between different services within the ecosystem"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="A higher transaction throughput on the Stellar Network "
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="The ability to create private transactions within the network"
              name="checkfour"
              id="form4"
