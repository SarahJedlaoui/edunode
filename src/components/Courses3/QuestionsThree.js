  ...
  render() {
    return (
      <>
        ...
        <h5>
        What is the primary goal of SEP-10?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="To provide a consistent interface for wallets to execute deposit and withdrawal operations"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="To specify an authentication protocol that allows Anchors and wallets to verify the identity of users securely"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="To offer an interactive, web-based interface for depositing and withdrawing assets"
              name="checkfour"
              id="form4"
