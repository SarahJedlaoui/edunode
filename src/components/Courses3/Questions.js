  ...
  render() {
    return (
      <>
        ...
        <h5>
        What is the primary purpose of Stellar Ecosystem Proposals (SEPs)?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label=" To propose new features for the Stellar Network"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="To define a standard way for various components within the Stellar ecosystem to work together seamlessly"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="To vote on changes to the Stellar Network's consensus algorithm"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="To regulate the issuance of new Stellar Lumens (XLM)"
              name="checkfour"
              id="form4"
