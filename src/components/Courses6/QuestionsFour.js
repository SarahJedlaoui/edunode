      ...
      <>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="A type of computer hardware"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="A digital application that runs on a single computer"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label=" A digital application or program that runs on a blockchain or P2P network of computers "
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="A software that helps in developing Ethereum"
              name="checkfour"
              id="form4"
