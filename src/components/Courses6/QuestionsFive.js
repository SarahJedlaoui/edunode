      ...
      <>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="A government program to decentralize financial institutions"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label=" A form of banking where all transactions are made in cryptocurrency"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="An umbrella term for financial applications in cryptocurrency or blockchain geared toward disrupting financial intermediaries"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label=" A new form of digital currency"
              name="checkfour"
              id="form4"
