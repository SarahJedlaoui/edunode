      ...
      <>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="A legally binding document between two parties"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="A self-executing contract with terms written into code"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="A written agreement signed by all members of the Ethereum network "
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="A software that assists in writing legal contracts"
              name="checkfour"
              id="form4"
