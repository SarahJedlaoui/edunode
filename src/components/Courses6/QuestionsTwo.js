  ...
  render() {
    return (
      <>
        ...
        <h5>
        What is Ether in the context of Ethereum?{' '}
        </h5>
        ...
        <Form.Group as={Row}>
          <Col sm={10}>
            <Form.Check
              type="checkbox"
              label="The space in which Ethereum operates"
              name="checkone"
              id="form1"
            ...
            <Form.Check
              type="checkbox"
              label="The programming language used to write Ethereum applications"
              name="checktwo"
              id="form2"
            ...
            <Form.Check
              type="checkbox"
              label="The native cryptocurrency of the Ethereum platform"
              name="checkthree"
              id="form3"
            ...
            <Form.Check
              type="checkbox"
              label="A type of memory storage used in Ethereum's blockchain"
              name="checkfour"
              id="form4"
