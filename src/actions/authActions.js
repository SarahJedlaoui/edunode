...
export const loadUser = () => (dispatch, getState) => {
    ...
    axios
      .get(
        'http://localhost:50011/api/auth/user',
...
fetch('http://localhost:50011/api/emailauth/', {
method: 'POST', 
headers: {
'Access-Control-Allow-Origin': '*',
'Content-Type': 'application/json'
...
console.log(email)
    ...
    fetch('http://localhost:50011/api/emaillogin/', {
      method: 'POST', 
      headers: {
  'Access-Control-Allow-Origin': '*',
  'Content-Type': 'application/json'
...
export const confirm = ({email, confirmationCode}) => (dispatch) => {
    ...
    fetch('http://localhost:50011/api/confirm', {
      method: 'POST', 
      headers: {
  'Access-Control-Allow-Origin': '*',
  'Content-Type': 'application/json'
...
export const resend = (email) => {
    ...
    axios.post('http://localhost:50011/api/resend', body, config);
...
export const verifyCode = ({ email, inputcode, id, next }) => async dispatch => {
    ...
    // .put('http://localhost:5001/api/users/username', body, config)
     await fetch('http://localhost:50011/api/verifycode', {
      method: 'POST', 
      headers: {
  'Access-Control-Allow-Origin': '*',
  'Content-Type': 'application/json'
...
export const saveUsername = ({ email, username }) => dispatch => {
    ...
    axios
      .put('http://localhost:50011/api/users/username', body, config)
      .then((res) => {
        dispatch({
          type: HAS_USERNAME,
          payload: res.data,
...
export const updateAccount = ({ email,
  ...
  axios
    .put('http://localhost:50011/api/users/useraccount', body, config)
    .then((res) => {
      dispatch({
